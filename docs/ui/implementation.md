...
回归入口为 `e2e/approved-v14.spec.mjs`（两种主题下无圆角与阴影、320–1440 不溢出、手机控件 ≥44px、后台列表首行对齐、等宽字体与 2px 焦点）、`e2e/approved-v12.spec.mjs`、`e2e/approved-v13.spec.mjs`、`e2e/public.spec.mjs`、`e2e/admin.spec.mjs` 和 `e2e/visual-contract.spec.mjs`。
